...
model_dir=/home/ec2-user/quic-efs/user/hansizeng/work/t5_pretrainer/t5_pretrainer/$experiment_dir/t5seq_aq_encoder_seq2seq_1_lng_knp_mnt_16_dcy_2/
pretrained_path=$model_dir/checkpoint

for max_new_token in 4 6 8 10 12 14 16 2 4
do
