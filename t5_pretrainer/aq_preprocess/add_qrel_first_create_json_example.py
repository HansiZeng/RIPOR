...
root_dir = f"/home/ec2-user/quic-efs/user/hansizeng/work/t5_pretrainer/t5_pretrainer/experiments-full-t5seq-aq/t5seq_aq_encoder_seq2seq_1_lng_knp_mnt_32_dcy_2"
...
qid_to_reldocid_to_score_path = "/home/ec2-user/quic-efs/user/hansizeng/work/data/msmarco-full/all_train_queries/qid_to_reldocid_to_score.json"

out_dir = os.path.join(root_dir, "qrel_first_sub_smtid_train_decay2")
...
print("distribution of relevant_scores: ", np.quantile(rel_scores, quantiles))
...
with open(os.path.join(out_dir, f"qrel_first_qid_smtids_scores_{max_new_token}.train.json"), "w") as fout:
