...
mnt_to_smtid_to_factor = {32: {"smtid_8": 0.75, "smtid_16": 0.875},
                          16: {"smtid_8": 0.75/0.875}}
...
source_example_path = os.path.join(root_dir, f"qrel_first_sub_smtid_train_decay2/qrel_first_qid_smtids_scores_{max_new_token}.train.json")
