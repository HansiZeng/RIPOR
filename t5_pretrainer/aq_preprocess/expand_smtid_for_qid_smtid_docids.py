...
src_qid_smtid_rankdata_path = os.path.join(root_dir, f"t5seq_aq_encoder_seq2seq_1/sub_smtid_{src_new_token}_out/qid_smtid_rankdata.json")
out_dir = os.path.join(root_dir, f"t5seq_aq_encoder_seq2seq_1/sub_smtid_{tgt_new_token}_out/")
